...
public class Student 
{
    ...
    public Student(int studId, String name, String phone, String email) throws StudentException
    {
        if (name.length() == 0)
        ...
        if (studId > lastUsedStudId)
            lastUsedStudId = studId + 1;
    ...
    {
        this (lastUsedStudId, name, phone, email);
